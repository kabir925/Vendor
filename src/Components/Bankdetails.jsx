              ...
              <div className="head-closed">
                <div className="closed-class">
                  ...
                  <div className="form-container">
                    ...
                    <div className="hero-head ">
                      <label for="BankIFSCCode" class="form-label">
                        Bank IFSC Code{" "}
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="form-container">
                    ...
                    <div className="hero-head">
                      <label htmlFor="WireCode" className="form-label">
                        Wire Code
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="form-container">
                    <div className="hero-head">
                      <label for="BankCustomerSupportEmail" class="form-label">
                        Bank Support Customer Email
                      </label>
                      <input
                        type="email"
                        id="BankCustomerSupportEmail"
                        name="BankCustomerSupportEmail"
                        className="form-control"
                        required
                      />
                    </div>
                    <div className="hero-head">
                      <label for="BankCustomerSupportMobile" class="form-label">
                        Bank Customer Care Number
                      </label>
                      <input
                        type="number"
                        id="BankCustomerSupportMobile"
                        name="BankCustomerSupportMobile "
                        className="form-control"
                        required
                      />
                    </div>
                  ...
                  <div className="form-container">
                    <div className="hero-head">
                      <label for="OtherDetails1" class="form-label">
                        Other 1
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="hero-head">
                      <label for="OtherDetails2" class="form-label">
                        Other 2
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="form-container">
                    <div className="hero-head">
                      <label for="OtherDetails3" class="form-label">
                        Other 3
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="hero-head">
                      <label for="OtherDetails4" class="form-label">
                        Other 4
                      </label>
                      <input
                        type="text"
